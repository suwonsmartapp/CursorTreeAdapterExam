...
public class ExamDbFacade {
    ...
    public void selectAll() {
        ...
        Cursor cursor = db.query(ExamDbContract.ExamDbEntry.TABLE_NAME,
                new String[]{ExamDbContract.ExamDbEntry.COLUMN_NAME_DATA_GROUP, ExamDbContract.ExamDbEntry.COLUMN_NAME_DATA_CHILD},
                null, null, null, null, null);

        while(cursor.moveToNext()) {

            String group = cursor.getString(cursor.getColumnIndexOrThrow(ExamDbContract.ExamDbEntry.COLUMN_NAME_DATA_GROUP));
            String child = cursor.getString(cursor.getColumnIndexOrThrow(ExamDbContract.ExamDbEntry.COLUMN_NAME_DATA_CHILD));

            System.out.println("부모 : " + group);
    ...
    public ArrayList<String> select() {
         ...
         */
        Cursor cursor = db.query(ExamDbContract.ExamDbEntry.TABLE_NAME,
                new String[]{ExamDbContract.ExamDbEntry.COLUMN_NAME_DATA_GROUP},
                null, null, null, null, null);
         ...
         */
        while (cursor.moveToNext()) {
            String data = cursor.getString(cursor.getColumnIndexOrThrow(ExamDbContract.ExamDbEntry.COLUMN_NAME_DATA_GROUP));
            result.add(data);
        }
    ...
    public ArrayList<String> delete(String delete) {
         ...
         */
        db.delete(ExamDbContract.ExamDbEntry.TABLE_NAME, ExamDbContract.ExamDbEntry.COLUMN_NAME_DATA_GROUP + " = ?", new String[]{delete});
